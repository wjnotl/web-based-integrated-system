...
$(document).ready(function () {
	...
	$(".delete-voucher-button").on("click", async function () {
		$(this).prop("disabled", true)
		$(this).text("Deleting...")
		if (await confirmation("Are you sure you want to delete this voucher?", "Yes")) {

			const response = await $.ajax({
				url: "/backend/admin/do.delete-voucher.php",
				method: "POST",
				data: {
					id: $(this).data("id")
				}
	...
	$(".copy-link-button").on("click", async function () { 
		...
		try {
			...
			const textArea = $("document").append("<textarea>")
