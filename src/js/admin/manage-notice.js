...
$(document).ready(function () {
	...
	$(".delete-notice-button").on("click", async function () {
		$(this).prop("disabled", true)
		$(this).text("Deleting...")
		if (await confirmation("Are you sure you want to delete this notice?", "Yes")) {

			const response = await $.ajax({
				url: "/backend/admin/do.delete-notice.php",
				method: "POST",
				data: {
					id: $(this).data("id")
				}
