...
$(document).ready(function () {
	...
	$(".delete-product-button").on("click", async function () {
		$(this).prop("disabled", true)
		$(this).text("Deleting...")
		if (await confirmation("Are you sure you want to delete this product?", "Yes")) {

			const response = await $.ajax({
				url: "/backend/admin/do.delete-product.php",
				method: "POST",
				data: {
					id: $(this).data("id")
				}
