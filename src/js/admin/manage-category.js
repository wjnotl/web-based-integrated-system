...
$(document).ready(function () {
	...
	$(".delete-category-button").on("click", async function () {
		$(this).prop("disabled", true)
		$(this).text("Deleting...")
		if (await confirmation("Are you sure you want to delete this category?", "Yes")) {

			const response = await $.ajax({
				url: "/backend/admin/do.delete-category.php",
				method: "POST",
				data: {
					id: $(this).data("id")
				}
